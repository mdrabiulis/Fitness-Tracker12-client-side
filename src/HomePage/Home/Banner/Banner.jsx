      ...
      >
        <SwiperSlide>
          ...
          <div className="text-white absolute bottom-0 xl:bottom-20 right-2 xl:right-20  md:my-2 lg:my-6 py-8 md:p-10  bg-black bg-opacity-70">
            <h3 className="border border-yellow-500 rounded-md md:mt-3 md:mb-5 w-52 md:p-2">WELCOME TO FITCLASS</h3>
            ...
            <p className="text-xs md:text-base lg:text-2xl my-2 md:my-4">
              Fitclass is more than a place where high <br></br>performers come to be
              their best.
            </p>
            <div className="space-x-5">
            <button className="bg-[#FF5D28] p-1 md:p-2 rounded-md">Read More</button>
            <button className="bg-[#26335A] p-1 md:p-2 rounded-md">Appointment Now</button>
            </div>
          </div>
        </SwiperSlide>
         <SwiperSlide>
