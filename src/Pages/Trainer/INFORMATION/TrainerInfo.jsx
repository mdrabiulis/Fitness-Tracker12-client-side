      ...
      <div className="flex flex-col md:flex-row md:gap-4 lg:gap-0 max-w-7xl mx-auto mb-10">
        ...
        <div className=" md:w-2/3 lg:w-2/4 ml-10 mt-6 md:mt-0 md:ml-0 text-lg font-semibold ">
          ...
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 justify-start md:gap-6 ">
            <h2 className="font-bold">Name : <span className="text-slate-600">{name}</span></h2>
            <h2 className="font-bold">Special :<span className="text-slate-600"> {special}</span></h2>
          </div>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 justify-start md:gap-[45px]">
            <h2 className="font-bold">Experience :<span className="text-slate-600"> {experience}</span></h2>
            <h2 className="font-bold">Phone : <span className="text-slate-600">{phone}</span></h2>
          </div>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 justify-start md:gap-[105px]">
            <h2 className="font-bold">Age : <span className="text-slate-600">{age}</span></h2>
            <h2 className="font-bold ">Email :<span className="text-slate-600 "> {email}</span></h2>
          </div>
          <h3 className="">Introduction</h3>
          <p className="text-sm"><span className="text-slate-600">{introduction}</span></p>
